...
// Внутренний номер плана → отображаемый (план 6 скрыт: 7 → 6, 8 → 7, 9 → 8)
...
function buildSnapshotBlocks(snapshot, { addPageBreakBefore = false } = {}) {
    ...
    // План 6 скрыт, выводим внутренние 1..5,7,8,9 (отображаем 1..8)
    const ALL_PLAN_ORDER = [1, 2, 3, 4, 5, 7, 8, 9];
