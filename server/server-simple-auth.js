...
app.post('/api/plans/download', authenticateToken, async (req, res) => {
    try {
        ...
        const planTitles = {
            ...
            2: 'Прием и рассмотрение граждан, предотвращение и урегулирование социальных конфликтов',
            3: 'Эффективность работы по рассмотрению обращений физических и юридических лиц',
            4: 'Информирование населения по вопросам социальной защиты (инфографика)',
            5: 'Обеспечение профилактики правонарушений среди несовершеннолетних и молодежи',
            6: 'Реализация Дорожной карты по исполнению и развитию трудового законодательства Республики Казахстан',
            7: 'Эффективность контроля за рабочим временем и временем отдыха работников организаций',
            8: 'Обеспечение наполнения интернет-ресурса территориального департамента'
        };
